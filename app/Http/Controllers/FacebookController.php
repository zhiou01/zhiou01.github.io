...
class FacebookController extends Controller
{
    ...
    /**
     * Show user's facebook pages. / Home page
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */

    public function index()
    {
        // if package is not available for this user then show 404 page
    ...
    /**
     * Home page for showing my facebook groups
...
//            $responseForGroup = $fb->get('me/?fields=groups{access_token,id,name,picture,fan_count,feed.limit(10){id,created_time,message,with_tags,from{id,name,picture},link,comments{id,message,comments,from{id,name,picture},created_time},reactions{type}}}', Data::get('fbAppToken'));
            $responseForGroup = $fb->get('me/?fields=groups.limit(1000)', Data::get('fbAppToken'));
            $bodyForGroup = $responseForGroup->getBody();
...
//        return view('fbgroups', compact('message', 'totalReactions', 'sad', 'likes', 'love', 'haha', 'wow', 'angry', 'data', 'token'));
    ...
    /**
     * Delete content from my facebook page/group
     * @param Request $re
     * @return string
    ...
    /**
     * Delete data form facebook group
     * @param $id
     * @return string
     */
    ...
    /**
     * Facebook report view where you can select a page to view the report
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    ...
    /**
     * Mass message sending from facebook page
     *
     * @param $pageId
    ...
    /**
     *
     * Massive reply for facebook page
     *
     * @param $pageId
     * @return string
     */
...
//
    ...
    /**
     *
     * Massive comment for facebook page
     *
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    ...
    /**
     * Mass comment action for facebook
     * @param Request $request
     */
    ...
    /**
     * Massive comment action for facebook pages
     * @param Request $request
     */
    ...
    /**
     *
     * Delete saved facebook page from database
     *
     * @param Request $request
     * @return string
     */
