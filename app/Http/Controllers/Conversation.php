...
class Conversation extends Controller
{
    ...
    /**
     * Facebook conversations home page
    ...
    /**
     * Get inbox messages for specific page
     * @param $pageId
     * @param $cId
    ...
    /**
     * get message from specific person from facebook page
     * @param $pageId
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View|string
     */
    ...
    /**
     * Ajax request for get simultaneously message from page
     * @param $pageId
     * @param $cId
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View|string
     */
    ...
    /**
     * Send message to single person ( Facebook )
     * @param Request $re
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View|string
     */
    ...
    /**
     * Send message using message node
     * @param $pageId
     * @param $mId
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View|string
     */
