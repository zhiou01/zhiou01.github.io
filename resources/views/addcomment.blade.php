                            ...
                            <div class="cmt-top">
                                ...
                                <div class="cmt-sec">
                                    ...
                                    <div class="comment"><i id="clsbtn">&nbsp</i>
                                        <div class="namecomment"><a href="#" id="namecomment">Jhon Doe</a>
                                            <c id="userComment"> Some comment</c>

                                        </div>
                                        <div class="likereply"><a href="#">Like</a><a href="#">Reply</a><a href="#">Message</a>
                                            <a href="#"
                                               id="thumb"><i
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="control-label"><input type="checkbox" id="specific"> Reply for
                                        specific post</label>
                            ...
                            <div id="postIdDiv" class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="Example : 925072217615350_1036772243112013"
                                           id="postId" class="form-control">
