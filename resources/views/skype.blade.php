                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        ...
                                        <li>
                                            <div align="center">
                                                <div class="btn-group">
                                                    <button type="button" id="savePhone" class="btn btn-success"><i
                                                                class="fa fa-phone"></i> Collect phone numbers form
                                                        contacts
                                                    </button>
                                        ...
                                        <li>
                                            ...
                                            <div style="padding: 10px" class="form-group">
                                                <input type="text" placeholder="Contact usrname" class="form-control"
                                                       id="contact">
                                                <textarea placeholder="Rquest message ( Optional )" class="form-control"
                                                          id="reqMessage" rows="3"></textarea>
