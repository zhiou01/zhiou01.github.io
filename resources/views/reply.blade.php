            ...
            <section class="content">
                <div class="row">
                    ...
                    <textarea class="form-control" rows="4"
                        ...
                        <div class="form-group">
                            <button id="reply" class="btn btn-success"><i class="fa fa-reply"></i> Reply who mentioned
                                you
                            </button>
                            <button id="replyall" class="btn btn-primary"><i class="fa fa-reply"></i> Reply to all
                            </button>
                        </div>
                    </div>
                </div>
