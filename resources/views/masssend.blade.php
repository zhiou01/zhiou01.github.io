                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box box-widget widget-user">
                                ...
                                <div class="widget-user-header bg-black"
                                     style="background: url('@if(isset($page['cover'])){{$page['cover']['source']}}@endif') center center;">
                                ...
                                <div class="box-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 border-right">
                                            <div class="description-block">
                                                <a href="{{url('/masssend/')}}/{{$page['id']}}" class="btn btn-default"><i
                                                            class="fa fa-send"> Send mass message</i> </a>
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
