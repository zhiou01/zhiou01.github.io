                                ...
                                <div class="box box-widget">
                                    <div class="box-header with-border">
                                        ...
                                        <div class="box-tools">
                                            ...
                                            <a target="_blank"
                                               href="{{url('/instagram/info')."/".$data->media_or_ad->id}}"
                                    ...
                                    <div class="box-body">
                                        ...
                                        @if($data->media_or_ad->media_type == 1)
                                            <img class="img-responsive pad"
                                                 src="{{$data->media_or_ad->image_versions2->candidates[0]->url}}"
                                                 alt="Photo">
                                        @elseif($data->media_or_ad->media_type == 2)
                                            <video width="400" controls>
                                                <source src="{{$data->media_or_ad->video_versions[2]->url}}"
                                                        type="video/mp4">
                          ...
                          <span class="text-muted pull-right"><div class="time">
                                  {{--{{$comment->created_at}}--}}
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <div class="img-push">
                                            <input data-id="{{$data->media_or_ad->id}}" type="text"
