                                                    ...
                                                    <div class="post">
                                                        <div class="user-block">
                                                            <img class="img-circle img-bordered-sm"
                                                                 src="@if(isset($content['from']['picture']['data']['url'] )){{ $content['from']['picture']['data']['url'] }}@endif"
                                                                 alt="user image">
                                                            <span class='username'>
                                      <a target="_blank"
                                         href="http://facebook.com/@if(isset($content['from']['id']))@endif{{$content['from']['id']}}">{{ $content['from']['name'] }}</a>
                                                            ...
                                                            @foreach($content['comments']['data'] as $comNo => $com)
                                                                @if(isset($com['message']))
                                                                    <div style="padding-left: 20px" class="post">
                                                                        <div class="user-block">
                                                                            <img class="img-circle img-bordered-sm"
                                                                                 src="@if(isset($com['from']['picture']['data']['url'])){{$com['from']['picture']['data']['url']}} @endif"
                                                                                 alt="user image">
                                                                            <span class='username'>
                                                          <a target="_blank"
                                                             href="http://facebook.com/@if(isset($com['from']['id'])){{$com['from']['id']}}@endif">@if(isset($com['from']['name'])){{$com['from']['name']}}@endif</a>
