                ...
                <div class="box no-border">
                    <div class="box-header with-border">
                        <h3 class="box-title">All scheduled data <label
                                    class="badge">{{\App\OptLog::all()->count()}}</label></h3>
                        <p>
                            ...
                            <table id="mytable" class="table no-margin">
                                ...
                                @foreach($datas as $data)
                                    <tr>
                                        ...
                                        <td>@if($data->status=='success')<label
                                                    class="label label-success">Success</label>@else <label
                                                    class="label label-danger">Failed</label>@endif</td>
                                        <td>{{$data->type}}</td>
                                        <td>{{$data->from}}</td>
                                        <td>{{$data->created_at}}</td>
                                        <td>
                                            <div data-id="{{$data->id}}" class="logdel"><a class="label label-danger"><i
