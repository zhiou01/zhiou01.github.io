@extends('layouts.app')
@section('title','Profile | SocialLit')
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="timeFormat">
                                        <option @if(Auth::user()->timeFormat == 12) selected="selected"
                                                @endif value="12">12 Hours
                                        </option>
                                        <option @if(Auth::user()->timeFormat == 24) selected="selected"
                                                @endif value="24">24 Hours
                                        </option>
                                    </select>
                                </div>
                            </div><!-- /.box-body -->
