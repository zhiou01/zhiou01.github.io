                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="answer"
                                                  placeholder="Message's Reply"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Separate using comma (ex: #marketing, #developer) for
                                            multiple channel.</p>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="accuracy"
                                               placeholder="Matching accuracy for this message">
                            ...
                            <div class="box-body">
                                <form method="POST" action="update-slack-bot-config" id="bot-config-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                               value="{{\App\Http\Controllers\Data::get('slackBotMatchAcc')}}"
                                               class="form-control" id="matchAcc"
                                               placeholder="Matching accuracy for messages">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table class="table table-striped table-bordered dt-responsive slack-bot-messages"
                                       id="mytable">
                                    <thead>
                                    <tr>
                                        <th>#</th>
