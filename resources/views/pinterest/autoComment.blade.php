                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <br>
                            <p><b>Keywords</b></p>
                            <input placeholder="Nice,Cool ! .." type="text" class="form-control" id="keywords">
                            <br>
                            <button id="comment" class="btn btn-block btn-success"><i class="fa fa-comments"></i> Run
                                Auto Comment & Repin
                            </button>
                            <br>
                            <p id="msg"></p>
...
@section('js')
    ...
    <script>
        $("#comment").click(function () {
            ...
            $.ajax({
                url: '{{url('pinterest/auto/comment')}}',
                type: 'POST',
                data: {
                    'boardId': $('#board').val(),
